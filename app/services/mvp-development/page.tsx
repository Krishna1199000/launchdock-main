...
const features = [
  {
    ...
    description: "Quickly build and test your ideas with functional prototypes that validate your concept.",
    icon: Rocket,
    details: [
  ...
  {
    title: "Agile Sprints",
    description: "Deliver working features in short, focused sprints with continuous feedback loops.",
    icon: Calendar,
    details: [
  ...
  {
    title: "Quick Launch",
    description: "Get your product to market faster with lean development and focused feature sets.",
    icon: Zap,
    details: [
...
const benefits = [
  ...
  },
  {
    ...
    description: "Build only what you need, when you need it",
    icon: Target,
  },
  {
    title: "Validated Learning",
    description: "Test assumptions with real users quickly",
    icon: Users,
  },
  {
    title: "Scalable Foundation",
    description: "Built to grow as you succeed",
    icon: TrendingUp,
  },
];
...
const process = [
  {
    ...
    description: "Define core features and create a focused roadmap.",
  },
  {
    step: "02",
    title: "Rapid Development",
    description: "Build MVP features in agile sprints.",
  },
  {
    step: "03",
    title: "Testing & Launch",
    description: "Validate with users and launch quickly.",
  },
  {
    step: "04",
    title: "Iterate & Scale",
    description: "Gather feedback and iterate based on data.",
  },
];
      ...
      <section className="relative z-10 py-20 sm:py-32">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Lean, scalable minimum viable products that get you to market quickly and validate your ideas.
            </motion.p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Fast, focused, and built for validation
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Let's turn your idea into a working product quickly.
            </p>
            <Link href="/contact">
              <Button variant="hero" size="lg" className="group">
                Start Your Project
