...
const features = [
  {
    title: "SEO & Analytics",
    description: "Improve your search rankings and track performance with comprehensive SEO and analytics strategies.",
    icon: Search,
    details: [
  ...
  },
  {
    ...
    description: "Rapid experimentation and data-driven strategies to accelerate your growth.",
    icon: Zap,
    details: [
  ...
  {
    title: "Optimization",
    description: "Continuous improvement of your digital presence for maximum impact.",
    icon: TrendingUp,
    details: [
...
const benefits = [
  ...
  },
  {
    ...
    description: "Track progress with clear KPIs and metrics",
    icon: Target,
  },
  {
  ...
  },
  {
    ...
    description: "Strategic consulting from industry experts",
    icon: Lightbulb,
  },
];
...
const process = [
  {
    ...
    description: "Analyze your current digital presence and identify opportunities.",
  },
  {
    step: "02",
    title: "Strategy Development",
    description: "Create a comprehensive digital strategy tailored to your goals.",
  },
  {
    step: "03",
    title: "Implementation",
    description: "Execute strategies and optimize for results.",
  },
  {
    step: "04",
      ...
      <section className="relative z-10 py-20 sm:py-32">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Help you grow and scale your digital presence with data-driven strategies and expert guidance.
            </motion.p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Comprehensive strategies to accelerate your growth
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Let's create a strategy that drives real results.
            </p>
            <Link href="/contact">
              <Button variant="hero" size="lg" className="group">
                Start Your Project
